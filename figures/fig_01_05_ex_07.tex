...
\addplot[domain=-3:-1,smooth,variable=\x,\colorone] plot ({\x},{2*\x+8});
\fill[black,draw=black,thick] (axis cs:-1,6) circle (1.5pt);
\addplot[domain=-1:3,smooth,variable=\x,\colorone] plot ({\x},{-1*\x+7});
\fill[white,draw=black,thick] (axis cs:-1,8) circle (1.5pt);
\end{axis}
