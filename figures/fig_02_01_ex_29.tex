\begin{tikzpicture}
\begin{axis}[clip=false,width=\marginparwidth+25pt,tick label style={font=\scriptsize},minor x tick num=1,axis y line=middle,axis x line=middle,ymin=-2.1,ymax=9.1,extra y tick labels={},xmin=-1.1,xmax=7.1,name=myplot]
	\addplot[domain=0:6,smooth,variable=\x,\colorone] plot ({\x},{(\x-3)*(\x-3)});
\end{axis}
