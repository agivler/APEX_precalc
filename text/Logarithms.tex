...
Our final answer is
	\begin{center}
		\begin{tabular}{| c |} \hline
			\\[-4pt]
			$4^{2y+1} = 2^{y-1}$ solves to give $\displaystyle y= \frac{-2}{3}$ \\[-4pt]
			\\\hline
		\end{tabular}
	\end{center}}\\
