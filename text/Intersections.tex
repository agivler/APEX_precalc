...
\begin{equation*}
	\begin{split}
		x & = \frac{-(-4) \pm \sqrt{(-4)^2-4(8)(-3)}}{2(8)} \\
		  & = \frac{4 \pm \sqrt{16+96}}{16} \\
		  & = \frac{4\pm \sqrt{112}}{16} \\
		  & = \frac{4 \pm 4 \sqrt{7}}{16} \\
...
\noindent
Now, we have both of the points of intersection: $(\frac{1 + \sqrt{7}}{4}, \frac{-1 + \sqrt{7}}{2})$ and $(\frac{1 - \sqrt{7}}{4}, \frac{-1 - \sqrt{7}}{2})$.
...
Now, we just need to find the $y$ coordinates. We can use either $f(x)$ or $g(x)$ to do this; $g(x)$ is simpler so we will use it. We get that $g(0) = 1$ and $g(1)=2$. Therefore, we have two points of intersection: $(0,1)$ and $(1,2)$.}\\
...
Now, we can take the result and easily solve for $y$, getting $y=2$. We can now use $y$ to find $x$. Either equation will work, but we will use the second one: $-x+(2) = 4$, or $x=-2$. This gives use one point of intersection at $(-2,2)$.
}\\
...
Solving $-\frac{5}{3}x = \frac{10}{3}$ gives us $x=-2$, and substituting into either equation gives us $y=2$. We get the same intersection point:$(-2,2)$.}\\
